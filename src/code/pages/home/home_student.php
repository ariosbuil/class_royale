...
// Select the professor assigned to the student
$queryProfessorId = "SELECT professor_id FROM Student WHERE student_id = $studentId";
$resultProfessorId = mysqli_query($conn, $queryProfessorId);
$rowProfessorId = mysqli_fetch_assoc($resultProfessorId);
$professorId = $rowProfessorId['professor_id'];

// We get all the projects associated with the professor, meaning the projects the student is assigned to
$queryProjects = "SELECT * FROM Project WHERE professor_id = $professorId";
$resultProjects = mysqli_query($conn, $queryProjects);

// We get all the projects associated with the professor, meaning the projects the student is assigned to
$queryProjects2 = "SELECT * FROM Project WHERE professor_id = $professorId";
$resultProjects2 = mysqli_query($conn, $queryProjects2);
?>
    ...
    <div class="content-home-screen flex">
      ...
      <div class="projects-shows">
        ...
        <div class="show-projects">
          <?php
          // Verifiy if there are projects associated with the professor
          while ($row = mysqli_fetch_assoc($resultProjects)) {
          ?>
            <div class="card-project">
              <?php echo '<img style="height: 200px"; "width: 200px"; src="data:image/jpeg;base64,' . base64_encode($row['photo']) . ' " alt="Project Picture">'; ?>
      ...
      <div class="events-shows">
        ...
        <div class="event-section-shows">
          ...
          <?php
          while ($row2 = mysqli_fetch_assoc($resultProjects2)) {
          ?>
            <div class="card-event-upcoming flex">
              <?php echo '<img style="height: 100px"; "width: 100px" src="data:image/jpeg;base64,' . base64_encode($row2['photo']) . ' " alt="Project Picture">'; ?>
