...
if ($_SERVER['REQUEST_METHOD'] == "POST" && isset($_POST['update'])) {
    ...
    $query = "UPDATE Activity SET project_id = '$selectedProject_id', professor_id = '$professor_logged', name = '$name', total_score = '$total_score', activity_item_id = '$selectedItem_id' WHERE activity_id = '$activity_id'";
